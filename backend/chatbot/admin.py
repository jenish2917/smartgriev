...
# Chatbot models are unregistered from admin - these are system-managed
# Chat logs and sessions should be viewed through custom analytics dashboards
# Use the chatbot API endpoints for managing templates and notifications
